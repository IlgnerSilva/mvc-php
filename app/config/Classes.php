...
class clsLocale {
  ...
  function LoadTranslation($filename = "") {
    $this->Messages = array();
    $this->Messages["ccs_advsearchallwords"] = "Todas as Palavras";
    $this->Messages["ccs_advsearchanyofwords"] = "Qualquer Palavra";
    $this->Messages["ccs_advsearchconditionscaption"] = "Procurar por";
    $this->Messages["ccs_advsearchexactphrase"] = "Frase Exata";
    $this->Messages["ccs_asc"] = "Crescente";
    ...
    $this->Messages["ccs_cannotseek"] = "Não foi possível encontrar o registro solicitado.";
    ...
    $this->Messages["ccs_customoperationerror_missingparameters"] = "ERRO FATAL: Faltam um ou mais parâmetros para concluir a operação de Atualizar/Apagar. A aplicação não está configurada corretamente.";
    $this->Messages["ccs_databasecommanderror"] = "ERRO FATAL: Erro na consulta ao banco de dados.";
    ...
    $this->Messages["ccs_desc"] = "Decrescente";
    $this->Messages["ccs_directoryformprefix"] = "Diretório de";
    $this->Messages["ccs_directoryformsuffix"] = "";
    $this->Messages["ccs_editablegridformprefix"] = "Atualizar";
    $this->Messages["ccs_editablegridformsuffix"] = "";
    $this->Messages["ccs_filenotfound"] = "O arquivo {0} especificado no item {1} não foi encontrado.";
    $this->Messages["ccs_filesfoldernotfound"] = "Unable to upload the file specified in {0} - upload folder doesn't exist.";
    $this->Messages["ccs_fileupload"] = "Enviar Arquivo";
    $this->Messages["ccs_filter"] = "Palavra-chave";
    $this->Messages["ccs_first"] = "Primeiro";
    $this->Messages["ccs_galleryformprefix"] = "";
    $this->Messages["ccs_galleryformsuffix"] = "Galeria de";
    $this->Messages["ccs_gridformprefix"] = "";
    $this->Messages["ccs_gridformsuffix"] = "";
    $this->Messages["ccs_gridpagenumbererror"] = "Número de página não é válido.";
    $this->Messages["ccs_gridpagesizeerror"] = "ERRO FATAL: Tamanho da página não é válido.";
    $this->Messages["ccs_incorrectemailformat"] = "Formato de e-mail no item {0} não é válido.";
    $this->Messages["ccs_incorrectformat"] = "O valor informado no item {0} não é válido. Utilize o formato: {1}.";
    $this->Messages["ccs_incorrectphoneformat"] = "Formato de telefone no item {0} não é válido.";
    $this->Messages["ccs_incorrectvalue"] = "O valor informado no item {0} não é válido.";
    $this->Messages["ccs_incorrectzipformat"] = "Formato de CEP no item {0} não é válido.";
    $this->Messages["ccs_insert"] = "Salvar";
    $this->Messages["ccs_insertlink"] = "Inserir Novo";
    $this->Messages["ccs_insufficientpermissions"] = "ERRO FATAL: Aplicação não tem as permissões necessárias para efetuar a gravação do arquivo em {0}.";
    $this->Messages["ccs_languageid"] = "pt";
    $this->Messages["ccs_largefile"] = "Tamanho do arquivo no item {0} é maior que o permitido.";
    $this->Messages["ccs_last"] = "Último";
    $this->Messages["ccs_localeid"] = "BR";
    $this->Messages["ccs_login"] = "Autenticação";
    $this->Messages["ccs_login_autologin_caption"] = "Mantenha-me conectado";
    $this->Messages["ccs_login_form_caption"] = "Autenticação para Acesso";
    $this->Messages["ccs_loginbtn"] = "Entrar";
    $this->Messages["ccs_loginerror"] = "Usuário ou Senha são incorretos.";
    $this->Messages["ccs_logoutbtn"] = "Sair";
    $this->Messages["ccs_main"] = "Principal";
    $this->Messages["ccs_maskvalidation"] = "Máscara de validação do item {0} falhou.";
    $this->Messages["ccs_maximumlength"] = "A quantidade de caracteres no item {0} não pode ser maior que {1}.";
    $this->Messages["ccs_maximumvalue"] = "O valor no item {0} não pode ser maior que {1}.";
    $this->Messages["ccs_minimumlength"] = "A quantidade de caracteres no item {0} não pode ser menor que {1}.";
    $this->Messages["ccs_minimumvalue"] = "O valor no item {0}  não pode ser menor que {1}.";
    $this->Messages["ccs_more"] = "Mais...";
    $this->Messages["ccs_next"] = "Próximo";
    $this->Messages["ccs_nextmonthhint"] = "Próximo Mês";
    $this->Messages["ccs_nextquarterhint"] = "Próximo Bimestre";
    $this->Messages["ccs_nextthreemonthshint"] = "Próximo Trimestre";
    $this->Messages["ccs_nextyearhint"] = "Próximo Ano";
    $this->Messages["ccs_nocategories"] = "Nenhuma categoria encontrada";
    $this->Messages["ccs_noevents"] = "Sem eventos";
    $this->Messages["ccs_norecords"] = "Sem registros";
    $this->Messages["ccs_now"] = "Hoje";
    $this->Messages["ccs_of"] = "de";
    $this->Messages["ccs_operationerror"] = "ERRO FATAL: Não foi possível completar a transação {0}. Um ou mais parâmetros não foram especificados.";
    $this->Messages["ccs_password"] = "Senha";
    $this->Messages["ccs_previous"] = "Anterior";
    $this->Messages["ccs_prevmonthhint"] = "Mês Anterior";
    $this->Messages["ccs_prevquarterhint"] = "Bimestre Anterior";
    $this->Messages["ccs_prevthreemonthshint"] = "Trimestre Anterior";
    $this->Messages["ccs_prevyearhint"] = "Ano Anterior";
    $this->Messages["ccs_recordformprefix"] = "Atualizar";
    $this->Messages["ccs_recordformprefix2"] = "Visualizar";
    $this->Messages["ccs_recordformsuffix"] = "";
    $this->Messages["ccs_recperpage"] = "Registros por Página";
    $this->Messages["ccs_rememberlogin"] = "Lembrar meu Usuário e Senha";
    $this->Messages["ccs_reportformprefix"] = "Relatório de";
    $this->Messages["ccs_reportformsuffix"] = "";
    $this->Messages["ccs_reportpagenumber1"] = "Página";
    $this->Messages["ccs_reportpagenumber2"] = "de";
    $this->Messages["ccs_reportprintlink"] = "Versão para impressão";
    $this->Messages["ccs_reportsubtotal"] = "Sub Total";
    $this->Messages["ccs_reporttotal"] = "Total Geral";
    $this->Messages["ccs_requiredfield"] = "O preenchimento do item {0} é obrigatório.";
    $this->Messages["ccs_requiredfieldupload"] = "Um arquivo no item {0} é obrigatório.";
    ...
    $this->Messages["ccs_search"] = "Procurar";
    $this->Messages["ccs_searchformprefix"] = "Procurar";
    $this->Messages["ccs_searchformsuffix"] = "";
    $this->Messages["ccs_selectfield"] = "Escolha um item";
    $this->Messages["ccs_selectorder"] = "Escolha uma Ordem";
    $this->Messages["ccs_selectvalue"] = "Escolha um Valor";
    $this->Messages["ccs_sortby"] = "Ordernar por";
    $this->Messages["ccs_sortdir"] = "Ordenação";
    $this->Messages["ccs_submitconfirmation"] = "Salvar registro(s)?";
    ...
    $this->Messages["ccs_totalrecords"] = "Total de Registro(s):";
    $this->Messages["ccs_uniquevalue"] = "O valor informado no item {0} já existe no banco de dados e não é permitido duplicação.";
    $this->Messages["ccs_update"] = "Salvar Alterações";
    $this->Messages["ccs_uploadcomponenterror"] = "ERRO FATAL: Inicialização do componente de upload falhou.";
    ...
    $this->Messages["ccs_uploadingerror"] = "Ocorreu um erro na tentativa de upload do arquivo no item {0}. Descrição do erro: {1}.";
    $this->Messages["ccs_uploadingtempfoldererror"] = "ERRO FATAL: O upload na pasta temporária do arquivo definido no item {0} falhou. Descrição do erro: {1}.";
    $this->Messages["ccs_wrongtype"] = "Tipo de arquivo no item {0} não é permitido.";
    $this->IsLoaded = true;
  }
